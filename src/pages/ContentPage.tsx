          ...
          <div className="prose prose-lg max-w-none">
            ...
            {slug === 'contact-us' && (
              <div className="mt-12 space-y-12">
                ...
                <div className="bg-dark text-white p-8 md:p-12 rounded-2xl shadow-2xl">
                  <h3 className="text-2xl font-black uppercase tracking-tighter mb-8">Send us a message</h3>
                  <form 
                    onSubmit={async (e) => {
                      e.preventDefault();
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-[10px] font-black uppercase tracking-widest text-white/60">Your Name</label>
                        <input 
                          name="name"
                          type="text" 
                          required
                          className="w-full bg-white/10 border border-white/20 px-4 py-3 focus:outline-none focus:border-primary font-bold text-sm rounded-lg"
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        required
                        rows={5}
                        className="w-full bg-white/10 border border-white/20 px-4 py-3 focus:outline-none focus:border-primary font-medium text-sm rounded-lg"
